...
Exact qualified lifecycle, single-flight:
  restart+ready → seed(clean) → dispatch_collector(CONSUMES invocation #53)
...
Bound to exact SHA 83c56cb6d9782b60dc81aa019bcb9bb8a73bb2e0.
Consumes ONE field unit at dispatch_collector (invocation #53).
"""
import sys, json
...
# ---- 2. dispatch collector (CONSUMES THE UNIT — invocation #53) ----
log("DISPATCH COLLECTOR (consumes invocation #53)")
