...
Hot path
--------
This module imports nothing from umh's hot path. It only depends on
``umh.substrate.meeting_sources`` (the bounded protocol module).
"""
...
class GoogleMeetSource:
    ...
    def from_bridge(
        ...
        *,
        ...
        """
        from umh.substrate.meet_caption_bridge import (  # local to avoid cycles
            make_bridge_hook,
        )
    ...
    def bridge_path(self) -> Optional[Any]:
        ...
        """
        from umh.substrate.meet_caption_bridge import bridge_path_for
