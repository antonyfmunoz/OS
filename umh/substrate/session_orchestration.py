...
def actual_sessions(target: str = "vps") -> list[dict[str, Any]]:
    ...
    """
    try:
        from umh.substrate.claude_session_bridge import list_sessions
...
def session_health(target: str, session_name: str) -> dict[str, Any]:
    ...
    checked_at = _now_iso()
    try:
        from umh.substrate.claude_session_bridge import session_status
    except Exception as exc:  # noqa: BLE001
        return {
...
def ensure_expected_sessions() -> dict[str, Any]:
    ...
    """
    try:
        from umh.substrate.claude_session_bridge import ensure_session
    except Exception as exc:  # noqa: BLE001
