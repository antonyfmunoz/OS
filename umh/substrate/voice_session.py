...
from umh.substrate.roles import AgentRole, RoleRegistry
...
def _apply_operator_state(session: "VoiceSession", lifecycle: str) -> None:
    ...
    """
    try:
        from umh.substrate.operator_transitions import apply_voice_session
...
class VoiceSessionRuntime:
    ...
    def end_session(
        ...
        *,
        ...
        try:
            from umh.substrate.audio_loop import mark_inactive
    ...
    def submit_utterance(
        ...
        *,
        ...
        try:
            from umh.substrate.audio_loop import (
                mark_listening,
                record_transcript,
            )
        ...
        try:
            from umh.substrate.audio_loop import mark_responding
        ...
        try:
            from umh.substrate.audio_loop import mark_cooling_down
