...
from umh.runtime_engine.strategy_engine import StrategyEngine, _parse_labeled_sections
...
class RealityIntelligenceEngine:
    ...
    def scan_market_signals(self, venture_id: str) -> list[dict]:
        ...
        output = run_via_umh(
            ...
            agent_type="reality_engine.scan",
    ...
    def run_competitor_analysis(
        ...
        output = run_via_umh(
            message=prompt,
            unified_context=_uctx,
            agent_type="reality_engine.competitor",
            authority_class="analyze",
            session_id=_sid,
            org_id=str(self.ctx.org_id),
            task_type=TaskType.ANALYZE,
    ...
    def generate_truth_report(self, venture_id: str) -> str:
        ...
        synthesis_output = run_via_umh(
            message=synthesis_prompt,
            unified_context=_uctx,
            agent_type="reality_engine.truth_synthesis",
            authority_class="analyze",
            session_id=_sid,
            org_id=str(self.ctx.org_id),
            task_type=TaskType.ANALYZE,
        ...
        report = (
            ...
            f"{'─' * 48}\n\n" + (synthesis_output or "Synthesis failed — check logs.")
        )
        ...
        try:
            self.memory.log_event(
                ...
                payload={
                    ...
                    "preview": (synthesis_output or "")[:400],
                },
            )
        except Exception:
            pass
