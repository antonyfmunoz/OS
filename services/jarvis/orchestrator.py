"""Jarvis Orchestrator — unified facade for trace, proof, memory, and workstation.
...
from services.jarvis.memory.candidate_generator import MemoryCandidateGenerator
...
from services.jarvis.observability.trace_store import TraceStatus, TraceStore
...
class JarvisOrchestrator:
    """Facade that coordinates all Jarvis subsystems."""

    def __init__(self, data_root: str | Path = "data/jarvis"):
        root = Path(data_root)
    ...
    def get_traces(
        ...
        *,
        ...
        """Query traces. Suitable for GET /api/jarvis/traces."""
    ...
    def get_resume(self) -> dict[str, Any]:
        """Build resume state. Suitable for GET /api/jarvis/resume."""
