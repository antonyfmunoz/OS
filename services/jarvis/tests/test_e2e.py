"""End-to-end test for Jarvis trace, proof, memory candidate, and workstation state.
...
from services.jarvis.memory.candidate_generator import (
    MemoryCandidate,
    MemoryCandidateGenerator,
    PromotionStatus,
)
from services.jarvis.observability.outcome_classifier import (
    ClassificationResult,
    OutcomeCategory,
    OutcomeClassifier,
)
from services.jarvis.observability.proof_store import ProofArtifact, ProofStore
from services.jarvis.observability.trace_store import Trace, TraceStatus, TraceStore
from services.jarvis.orchestrator import JarvisOrchestrator
from services.jarvis.workstation.state import (
    ResumeState,
    WorkstationProfile,
...
def test_orchestrator_e2e() -> None:
    print("\n--- JarvisOrchestrator E2E ---")
    with tempfile.TemporaryDirectory() as td:
        orch = JarvisOrchestrator(td)
