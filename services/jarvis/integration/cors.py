"""CORS configuration for Jarvis API.
...
BACKEND_PORT = int(os.environ.get("JARVIS_BACKEND_PORT", "8093"))
FRONTEND_PORT = int(os.environ.get("JARVIS_FRONTEND_PORT", "5173"))


def cors_origins() -> list[str]:
    """Return all allowed CORS origins for the Jarvis API."""
    origins = [
        # Local development
    ...
    extra = os.environ.get("JARVIS_CORS_EXTRA_ORIGINS", "")
    if extra:
