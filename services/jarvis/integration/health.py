...
BACKEND_URL = os.environ.get("JARVIS_BACKEND_URL", "http://localhost:8093")
FRONTEND_URL = os.environ.get("JARVIS_FRONTEND_URL", "http://localhost:5173")
...
class HealthAggregator:
    """Aggregates health from all Jarvis-related services."""
    ...
    def check_all(self) -> dict[str, Any]:
        ...
        checks = {
            "backend": _probe(f"{self._backend}/api/jarvis/health"),
    ...
    def check_backend(self) -> dict[str, Any]:
        return _probe(f"{self._backend}/api/jarvis/health")
