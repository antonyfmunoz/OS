"""Jarvis Bridge — connects Jarvis model routing to runtime/model_router.py.
...
from services.jarvis.model_routing.capabilities import CapabilityClass
from services.jarvis.model_routing.config import RoutingConfig, load_routing_config
