"""Jarvis API server — FastAPI surface matching existing UMH service conventions."""
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Jarvis substrate runtime started")
    yield
    await _runtime.shutdown()
    logger.info("Jarvis substrate runtime shut down")


app = FastAPI(
    title="Jarvis — UMH Layer 0 Substrate",
    version="0.1.0",
    lifespan=lifespan,
)
...
@app.post("/api/jarvis/signal", response_model=SignalResponse)
