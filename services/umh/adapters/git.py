...
_READ_OPS = frozenset({"status", "diff", "log", "branch", "show", "blame", "shortlog", "tag_list", "remote_list"})
_WRITE_OPS = frozenset({"commit", "push", "merge", "rebase", "reset", "checkout", "stash", "tag_create", "branch_create"})
...
class GitAdapter(BaseAdapter):
    ...
    _DENIED_OPERATIONS: frozenset[str] = frozenset({
        ...
        "checkout", "stash", "tag_create", "branch_create",
    })
