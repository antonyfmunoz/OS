...
Library entrypoint:
    from execution.transport.station_daemon import StationDaemon
...
from execution.transport.actions import (
    ActionKind,
    ActionResult,
    ActionStatus,
    SafeAction,
)
from execution.transport.app_allowlist import resolve_app
from execution.transport.nodes import Node, NodeRegistry, NodeStatus, NodeType
from execution.transport.scenes import Scene, SceneStep, get_scene
from execution.transport.station import StationEvent
from execution.transport.station_bus import StationBus, get_station_bus
...
class StationDaemon:
    ...
    def _start_http_transport(self) -> None:
        ...
        try:
            import asyncio
            from execution.transport.node_transport import NodeTransportServer
