...
def build_tts_reply_envelope(
    ...
    *,
    ...
    try:
        from execution.transport.tts_sanitize import sanitize_tts_reply
...
def _handle_session_command(
    ...
    *,
    ...
    try:
        from execution.transport.session_control import clear_session, reset_session
...
def maybe_mirror_discord_text_message(
    ...
    *,
    ...
    try:
        from execution.transport.discord_mode_routing import resolve_discord_mode
        from execution.transport.mode_behavior import shape_reply
    ...
    try:
        from execution.transport.discord_mode_routing import resolve_discord_mode as _rdm
        from execution.transport.discord_mode_routing import resolve_mode_session as _rms
