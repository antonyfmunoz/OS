...
Usage (contract consumer side — substrate, not daemon):
    from execution.transport import StationContract, StationHeartbeat
...
from execution.transport.actions import SafeAction, ActionResult, ActionKind, ActionStatus
...
class StationContract:
    ...
    def propose(self, action: SafeAction) -> SafeAction:
        ...
        try:
            from execution.transport.station_bus import get_station_bus
