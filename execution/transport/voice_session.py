...
from execution.transport.roles import AgentRole, RoleRegistry
...
def _apply_operator_state(session: "VoiceSession", lifecycle: str) -> None:
    ...
    """
    try:
        from execution.transport.operator_transitions import apply_voice_session
...
class VoiceSessionRuntime:
    ...
    def end_session(
        ...
        *,
        ...
        try:
            from execution.transport.audio_loop import mark_inactive
    ...
    def submit_utterance(
        ...
        *,
        ...
        try:
            from execution.transport.audio_loop import (
                mark_listening,
                record_transcript,
            )
        ...
        try:
            from execution.transport.audio_loop import mark_responding
        ...
        try:
            from execution.transport.audio_loop import mark_cooling_down
