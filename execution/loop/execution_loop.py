...
Usage:
    from execution.loop.execution_loop import ExecutionLoop
...
from control_plane.goals.goal_selector import Goal, GoalSelector, GoalState, OutcomeTracker
...
class ExecutionLoop:
    ...
    def _default_publish(event_type: str, payload: dict) -> None:
        try:
            from control_plane.events.event_bus import get_bus
