...
def ingest_text_message(
    ...
    *,
    ...
    try:
        from eos_ai.substrate.workflow_delegation import enrich_metadata
...
def maybe_mirror_discord_text_message(
    ...
    *,
    ...
    try:
        from eos_ai.substrate.discord_mode_routing import resolve_discord_mode as _rdm
        from eos_ai.substrate.discord_mode_routing import resolve_mode_session as _rms
