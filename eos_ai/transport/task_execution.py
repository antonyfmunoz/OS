...
def _execute_via_pipeline(
    ...
    *,
    ...
    from eos_ai.substrate.task_decomposition import decompose_task
...
def _sync_pipeline_to_task(task: Task, pipeline: "TaskPipeline") -> None:
    ...
    if not task.required_capabilities:
        try:
            from eos_ai.substrate.capability_routing import infer_task_capabilities
...
def _execute_legacy(
    ...
    *,
    ...
    # ── Route the task ──────────────────────────────────────────────────────
    from eos_ai.substrate.capability_routing import route_task
...
def run_overnight_execution(
    ...
    *,
    ...
    """
    from eos_ai.substrate.task_queue import get_tasks_sorted_for_execution
