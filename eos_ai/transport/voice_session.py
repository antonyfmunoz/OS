...
def _apply_operator_state(session: "VoiceSession", lifecycle: str) -> None:
    ...
    """
    try:
        from eos_ai.substrate.operator_transitions import apply_voice_session
...
class VoiceSessionRuntime:
    ...
    def end_session(
        ...
        *,
        ...
        try:
            from eos_ai.substrate.audio_loop import mark_inactive
    ...
    def submit_utterance(
        ...
        *,
        ...
        try:
            from eos_ai.substrate.audio_loop import mark_responding
        ...
        try:
            from eos_ai.substrate.audio_loop import mark_cooling_down
