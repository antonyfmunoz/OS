...
from eos_ai.substrate.decision_engine import DecisionOutput, _compute_state_hash
...
# WORKFLOW_RUN left unregistered — callers register domain-specific generators.
