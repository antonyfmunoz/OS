...
from umh.runtime_engine.event_bus import get_bus  # noqa: E402
from umh.substrate.actions import ActionResult, ActionStatus  # noqa: E402
from umh.substrate.station import StationContract, StationEvent  # noqa: E402
from umh.substrate.station_bus import get_station_bus  # noqa: E402
from umh.substrate.station_drainer import drain_node  # noqa: E402
...
def main() -> int:
    ...
    get_bus().subscribe("station.pomodoro_started", _capture)
    ...
    bus._inbox_append(
        TEST_NODE, {"type": "event", "payload": {"event_type": "no_node"}}
    )  # noqa: SLF001
