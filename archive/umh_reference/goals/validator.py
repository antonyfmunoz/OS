...
Usage::
    ...
    from umh.goals.validator import GoalValidator, ValidationResult
...
class GoalValidator:
    ...
    def _check_dominated(
        ...
        for pid in meta_goal.parent_goals:
            ...
            utility_worse = meta_goal.utility_estimate < parent_utility - DOMINATION_MARGIN
            confidence_worse = meta_goal.confidence < parent_confidence - DOMINATION_MARGIN
                ...
                if mg is not None:
                    for gp in mg.parent_goals:
                        if gp == meta_goal.goal_id:
                            return f"cycle:transitive:{meta_goal.goal_id}->{current}->{gp}"
    ...
    def _check_capacity_pressure(
        ...
        from umh.goals.meta_goal import MAX_GOALS
    ...
    def _auto_correct(
        ...
        from umh.goals.meta_goal import MetaGoal as MG
