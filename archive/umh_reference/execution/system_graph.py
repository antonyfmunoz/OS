...
Usage::
    ...
    from umh.execution.system_graph import build_system_graph, execute_system_graph
    from umh.actions.router import ExecutionRouter
...
def execute_system_graph(
    ...
    for nid in execution_order:
        ...
        try:
            from umh.actions.router import ExecutionRequest
