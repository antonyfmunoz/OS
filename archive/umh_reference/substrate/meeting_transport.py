...
from umh.substrate.meeting_sources import is_meeting_source
...
class MeetingTransport:
    ...
    def play_reply(self, text: str) -> dict[str, Any]:
        ...
        try:
            from umh.substrate.discord_voice_playback import (
    ...
    def playback_status_snapshot(self) -> dict[str, Any]:
        ...
        try:
            from umh.substrate.playback_status import (
    ...
    def inject_utterance(
        ...
        *,
        ...
        try:
            from umh.substrate.transcript_inject import inject_transcript
        except Exception as e:  # noqa: BLE001
            return {"status": "import_failed", "detail": str(e)}
    ...
    def status_report(self, *, history_limit: int = 10) -> dict[str, Any]:
        ...
        try:
            from umh.substrate.result_query import audio_loop_snapshot
