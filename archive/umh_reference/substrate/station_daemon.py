...
Operator entrypoint:
    python3 -m umh.substrate.station_daemon --node-id antony-workstation
...
from umh.substrate.app_allowlist import resolve_app
from umh.substrate.nodes import Node, NodeRegistry, NodeStatus, NodeType
from umh.substrate.scenes import Scene, SceneStep, get_scene
from umh.substrate.station import StationEvent
from umh.substrate.station_bus import StationBus, get_station_bus
...
class StationDaemon:
    ...
    def _start_http_transport(self) -> None:
        ...
        try:
            import asyncio
            from umh.substrate.node_transport import NodeTransportServer
