...
from umh.runtime_engine.skill_registry import SkillRegistry, get_skill_registry, reset_skill_registry
...
class SkillImprovementEngine:
    ...
    def _fetch_skill_outcomes(self, skill_id: str) -> list[dict]:
        ...
        """
        try:
            from umh.storage.adapters.neon import get_conn, ORG_ID, resolve_skill
