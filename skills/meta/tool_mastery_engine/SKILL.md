...
TME is a UMH substrate subsystem that guarantees creator-level
expertise with every external tool, SaaS, API, adapter, runtime,
and capability UMH touches. Not beginner-level (copies from docs).
Not expert-level (knows rate limits).
