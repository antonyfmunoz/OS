---
name: prepare-war-room-agenda
description: "Build the weekly War Room meeting agenda by pulling live pipeline data, content performance, and open priorities — run before each weekly War Room meeting."
