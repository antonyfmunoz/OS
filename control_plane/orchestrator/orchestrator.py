...
def run_full_morning_cycle(ctx: EOSContext, return_content: bool = False):
    ...
    pa = None
    try:
        from control_plane.strategy.portfolio_advisor import PortfolioAdvisor
...
def run_ceo_morning_delegation(
    ...
    from control_plane.coordination.coordination_engine import CoordinationEngine as _CE
    from control_plane.strategy.portfolio_advisor import PortfolioAdvisor as _PA
...
def start_ambient_refresh_loop(ctx: EOSContext) -> None:
    ...
    def _refresh_loop() -> None:
        while True:
            ...
            try:
                from control_plane.proactive.proactive_engine import ProactiveIntelligenceEngine
