...
**File:** [[eos_ai-substrate-roles-py]] | **Line:** 90
**Signature:** `get(slug) → Optional[AgentRole]`

**Class:** [[eos_ai-substrate-roles-py-RoleRegistry]]

*No docstring.*

## Called By

- [[eos_ai-substrate-role_resolver-py-resolve_role]]
- [[eos_ai-substrate-role_resolver-py-substrate_slug_for]]
