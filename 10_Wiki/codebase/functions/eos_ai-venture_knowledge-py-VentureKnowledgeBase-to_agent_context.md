...
**File:** [[eos_ai-venture_knowledge-py]] | **Line:** 314
**Signature:** `to_agent_context(venture_id, detail, org_id) → str`
...
- [[eos_ai-venture_knowledge-py-VentureKnowledgeBase-get_ventures_from_db]]
