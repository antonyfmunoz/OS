...
**File:** [[eos_ai-substrate-wake_producer-py]] | **Line:** 204
**Signature:** `get_wake_producer_history() → WakeProducerHistory`

*No docstring.*

## Called By

- [[eos_ai-substrate-wake_producer-py-WakeProducerRuntime-__init__]]
