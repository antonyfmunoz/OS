...
# VentureKnowledgeBase.get

**File:** [[eos_ai-venture_knowledge-py]] | **Line:** 301
**Signature:** `get(venture_id) → Venture`
...
- [[eos_ai-agent_runtime-py-AgentRuntime-client]]
...
- [[eos_ai-orchestrator-py-CEOAgent-delegate_objective]]
