...
**File:** [[eos_ai-substrate-execution_contract-py]] | **Line:** 285
**Signature:** `from_dict(data) → ExecutionResult`
...
- [[eos_ai-substrate-execution_result_handler-py-ExecutionResultHandler-handle_result]]
