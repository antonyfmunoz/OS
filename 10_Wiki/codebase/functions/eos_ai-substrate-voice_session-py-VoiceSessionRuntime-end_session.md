...
# VoiceSessionRuntime.end_session

**File:** [[eos_ai-substrate-voice_session-py]] | **Line:** 540
**Signature:** `end_session(session_id) → Optional[VoiceSession]`
...
- [[scripts-substrate_voice_session_cli-py-cmd_end]]
