...
file: scripts/substrate_operator_state_smoke_test.py
line: 69
...
**File:** [[scripts-substrate_operator_state_smoke_test-py]] | **Line:** 69
**Signature:** `main() → int`
...
- [[eos_ai-substrate-operator_presence-py-line_for_transition]]
