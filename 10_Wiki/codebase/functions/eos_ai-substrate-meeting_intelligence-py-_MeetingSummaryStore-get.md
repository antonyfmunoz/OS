...
# _MeetingSummaryStore.get

**File:** [[eos_ai-substrate-meeting_intelligence-py]] | **Line:** 309
**Signature:** `get(node_id, meeting_id) → Optional[MeetingSummary]`

**Class:** [[eos_ai-substrate-meeting_intelligence-py-_MeetingSummaryStore]]

*No docstring.*

## Calls

- [[eos_ai-substrate-meeting_intelligence-py-_MeetingSummaryStore-_key]]

## Called By

- [[eos_ai-substrate-meeting_intelligence-py-_MeetingSummaryStore-memories]]
- [[eos_ai-substrate-meeting_intelligence-py-_MeetingSummaryStore-memory_count]]
