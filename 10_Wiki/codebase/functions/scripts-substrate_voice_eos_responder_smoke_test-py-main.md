...
**File:** [[scripts-substrate_voice_eos_responder_smoke_test-py]] | **Line:** 141
**Signature:** `main() → int`
...
- [[eos_ai-substrate-voice_eos_responder-py-is_eos_voice_responder_installed]]
...
- [[eos_ai-substrate-voice_session-py-reset_voice_session_store_for_tests]]
