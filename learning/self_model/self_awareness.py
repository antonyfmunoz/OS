...
Usage:
    from learning.self_model.self_awareness import SelfAwarenessEngine, SystemChange, ChangeType
    ...
    async def process_change(self, change: SystemChange) -> dict:
        ...
        for consequence in consequences:
            ...
            if 'notify' in consequence or 'discord' in consequence:
                try:
                    from governance.validation.output_validator import get_validator
