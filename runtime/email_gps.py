...
class EmailGPS:
    ...
    _FINANCIAL_SIGNALS = [
        ...
        'order confirmation', 'charge',
        'refund', 'transaction', 'billing',
    ...
    NOISE_SUBJECTS = [
        'commented on', 'replied to',
        'upvoted your', 'followed you',
        'mentioned you', 'liked your',
    ...
    _ACTION_REQUIRED_SIGNALS = [
        ...
        'we restricted your', 'we suspended your',
    ...
    def _classify_by_rules(
        ...
        if any(s in subject_lower or s in preview_lower[:100]
               for s in self._ACTION_REQUIRED_SIGNALS):
    ...
    _PLATFORM_ADDRESS_INDICATORS = (
        ...
        'notifications@', 'alerts@', 'updates@', 'mailer@',
        'bounce@', 'support@', 'info@', 'hello@', 'team@',
        'news@', 'billing@', 'invoice@', 'receipts@',
    ...
    _PLATFORM_DOMAINS = frozenset({
        ...
        'stripe.com', 'shopify.com', 'notion.so', 'slack.com',
        'discord.com', 'zoom.us', 'calendly.com', 'apify.com',
        'railway.app', 'vercel.com', 'anthropic.com', 'openai.com',
        'hostinger.com', 'supabase.com', 'termius.com',
        'fireflies.ai', 'canny.io', 'replit.com', 'cursor.sh',
        'netlify.com', 'heroku.com', 'digitalocean.com',
        'cloudflare.com', 'namecheap.com', 'godaddy.com',
        'canva.com', 'figma.com', 'framer.com', 'webflow.io',
        'posthog.com', 'mixpanel.com', 'segment.io', 'hubspot.com',
        'mailchimp.com', 'sendgrid.com', 'twilio.com',
        'typeform.com', 'notion.com', 'airtable.com',
        'neon.tech', 'planetscale.com', 'supabase.io',
        'whop.com', 'gumroad.com', 'kajabi.com', 'teachable.com',
        'thinkific.com', 'circle.so', 'skool.com',
...
{{"action_items": ["list of specific tasks"],
  "has_deadline": false,
  "urgency": "high|medium|low|none"}}""").strip()
    ...
    def reclassify_folder(
        ...
        try:
            ...
            print(
                f'[EmailGPS] Reclassifying {len(messages)} emails '
                f'from {label_name}...'
            )
            ...
            for msg_ref in messages:
                try:
                    ...
                    if new_folder != source_folder:
                        ...
                        print(
                            f'[EmailGPS] Moved {email.subject[:40]} '
                            f'→ {new_folder.value}'
                        )
                        moved += 1
                    else:
            ...
            print(
                f'[EmailGPS] Reclassify complete: '
                f'{moved} moved, {stayed} stayed, {errors} errors'
            )
    ...
    def migrate_and_delete_old_labels(
        ...
        try:
            ...
            label_map: dict[str, str] = {
                l['name']: l['id'] for l in all_labels
            }
            ...
            for old_name, new_name in old_to_new_map.items():
                ...
                for i in range(0, len(messages), batch_size):
                    ...
                    if ok:
                        ...
                        errors.append(
                            f'Batch modify failed for batch {i // batch_size} '
                            f'of {old_name}'
                        )

                if email_count:
                    print(
                        f'[EmailGPS] Migrated {email_count} emails: '
                        f'{old_name} → {new_name}'
                    )
