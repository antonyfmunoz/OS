...
from runtime.transport.operator_session import (
    OperatorDayMode,
    OperatorSession,
    OperatorSessionStore,
)
from runtime.transport.rituals import RitualKind, RitualRegistry, RitualState
...
def open_day(
    *,
    ...
    task_summary: dict = {}
    try:
        from runtime.transport.task_queue import get_enhanced_task_summary
    ...
    try:
        from runtime.transport.pipeline_execution import get_pipeline_summary
    ...
    try:
        from runtime.transport.auto_task_generation import get_perception_summary
    ...
    try:
        from runtime.transport.live_sessions import get_live_session_summary
    ...
    try:
        from runtime.transport.station_presence import get_station_summary
    ...
    node_health: dict = {}
    try:
        from runtime.transport.node_controller import get_node_health_summary
    ...
    try:
        from runtime.transport.task_queue import get_waiting_on_operator_tasks
...
def close_day(
    *,
    ...
    try:
        from runtime.transport.scenes import get_scene as _get_scene
    ...
    if day_mode == OperatorDayMode.OVERNIGHT:
        try:
            from runtime.transport.task_queue import prepare_overnight_queue
    ...
    if day_mode == OperatorDayMode.OVERNIGHT:
        try:
            from runtime.transport.task_system import run_overnight_tasks
    ...
    try:
        from runtime.transport.local_control import LocalControlStore
    ...
    try:
        from runtime.transport.station_presence import get_station_presence
