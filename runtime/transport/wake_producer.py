...
from runtime.transport.local_listener import (
    LocalListener,
    LocalTrigger,
    TriggerKind,
    TriggerStatus,
...
class WakeProducerRuntime:
    ...
    def submit(self, event: WakeProducerEvent) -> WakeProducerEvent:
        ...
        try:
            ...
            try:
                from runtime.transport.operator_transitions import apply_wake_event
            ...
            try:
                if event.action_taken in (
                    ...
                    from runtime.transport.audio_loop import mark_primed
