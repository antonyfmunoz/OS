...
def station_readiness_report(node_id: str) -> dict[str, Any]:
    ...
    try:
        ...
        from runtime.transport.station_readiness import station_readiness
    ...
    try:
        from runtime.transport.ritual_inference import infer_open_scene_hint
    ...
    try:
        from runtime.transport.scene_capabilities import scene_requirements_inventory
...
def recent_wake_producer_events(
    ...
    *,
    ...
    """
    try:
        from runtime.transport.wake_producer import get_wake_producer_history
    except Exception:
        return []
    try:
...
def operator_state_snapshot(
    ...
    """
    try:
        from runtime.transport.operator_state import get_operator_state_store
    except Exception:
...
def audio_loop_snapshot(
    ...
    """
    try:
        from runtime.transport.audio_loop import snapshot as _audio_snapshot
    except Exception:
...
def recent_audio_loop_transcripts(
    ...
    """
    try:
        from runtime.transport.audio_loop import get_audio_loop_store
    except Exception:
        return []
    try:
