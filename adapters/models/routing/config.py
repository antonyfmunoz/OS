...
This is the bridge between UMH symbolic labels and the existing
...
class RoutingConfig:
    ...
    def _apply_env_overrides(self) -> None:
        """Check env vars for provider overrides. Format: UMH_ROUTE_<CAPABILITY>=provider"""
        for cap in CapabilityClass:
            env_key = f"UMH_ROUTE_{cap.name}"
