...
Programmatic:
    ...
    q = GraphQuery.load()
    q.dependents("eos/memory.py")
    q.path("services/discord_bot.py", "eos/db.py")

A node can be a file path (eos/memory.py), a module
(eos_ai.memory), a class id (eos/memory.py::Memory), or
a function id (eos/memory.py::Memory.remember).
"""
