...
CLI
---
    python3 scripts/action_system.py query-graph --target eos/memory.py
    python3 scripts/action_system.py edit-file \\
        --target eos/memory.py --payload-file /tmp/new.py --dry-run
    python3 scripts/action_system.py edit-file \\
        --target eos/memory.py --payload-file /tmp/new.py --approve
...
from umh.governance.capability import (  # noqa: E402
    OperationKind,
