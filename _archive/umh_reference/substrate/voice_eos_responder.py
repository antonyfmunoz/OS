...
`umh.substrate.voice_session` and routes utterances into EOS via the
safest available entrypoint: `umh.model_router.call_with_fallback`.
...
def _build_prompt(session: VoiceSession, utterance: str) -> str:
    ...
    Pure-string output.
    """
    from umh.substrate.claude_session_bridge import _scrub_cli_chrome
