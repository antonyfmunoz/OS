...
from umh.substrate.control_commands import ControlCommand
...
class LocalRuntimeAdapter:
    ...
    def execute(self, request: ExecutionRequest) -> ExecutionResult:
        ...
        try:
            ...
            # Call the executor
            from umh.world.substrate import local_executor
...
class WorkstationAdapter:
    ...
    def execute(self, request: ExecutionRequest) -> ExecutionResult:
        ...
        try:
            ...
            from umh.substrate.node_transport import send_task_via_http
    ...
    def health(self) -> AdapterHealth:
        ...
        try:
            from umh.substrate.node_transport import check_http_health
