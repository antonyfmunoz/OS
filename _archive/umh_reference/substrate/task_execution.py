...
if TYPE_CHECKING:
    from umh.substrate.operator_session import OperatorSession
...
def _execute_via_pipeline(
    ...
    *,
    ...
    from umh.substrate.task_decomposition import decompose_task
    from umh.substrate.pipeline_execution import execute_pipeline
...
def _sync_pipeline_to_task(task: Task, pipeline: "TaskPipeline") -> None:
    ...
    """
    from umh.substrate.task_pipeline import PipelineStatus
    ...
    if not task.required_capabilities:
        try:
            from umh.substrate.capability_routing import infer_task_capabilities
...
def _execute_legacy(
    ...
    *,
    ...
    # ── Route the task ──────────────────────────────────────────────────────
    from umh.substrate.capability_routing import route_task
...
def run_overnight_execution(
    ...
    *,
    ...
    """
    from umh.substrate.task_queue import get_tasks_sorted_for_execution
