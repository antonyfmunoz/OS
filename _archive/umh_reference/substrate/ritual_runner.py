...
possible surface: a module that can be invoked as
    ...
    python3 -m umh.substrate.ritual_runner open_day start
    python3 -m umh.substrate.ritual_runner open_day finish <ritual_id>
    python3 -m umh.substrate.ritual_runner close_day start
    python3 -m umh.substrate.ritual_runner close_day finish <ritual_id>
    python3 -m umh.substrate.ritual_runner status

`start` prints the new ritual_id to stdout so bash callers can capture it:

    RID=$(python3 -m umh.substrate.ritual_runner open_day start)
    ...
    python3 -m umh.substrate.ritual_runner open_day finish "$RID"
...
def _apply_ritual_state(
    ...
    try:
        ...
        from umh.substrate.operator_transitions import apply_ritual
...
_USAGE = (
    "usage: python3 -m umh.substrate.ritual_runner "
