...
def _execute_step(
    ...
    *,
    ...
    # ── Route the step ──────────────────────────────────────────────────────
    try:
        from umh.substrate.capability_routing import choose_execution_target
        from umh.substrate.task_system import Task, TaskExecutionPolicy, TaskStatus
    ...
    try:
        from umh.substrate.task_execution import _resolve_tmux_target
    ...
    if result.get("ok"):
        ...
        from umh.substrate.task_execution import detect_human_block
