...
Design rules:
  ...
  - Safe default: JSON file at /opt/OS/umh/.substrate_state.json.
...
_JSON_PATH = Path("/opt/OS/umh/.substrate_state.json")
...
class NeonStorage:
    ...
    def __init__(self) -> None:
        try:
            from umh.runtime_engine.db import get_conn, ORG_ID  # import here so module-level fails are caught
        except ImportError:
            pass
