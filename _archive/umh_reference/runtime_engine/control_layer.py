...
Usage::
    ...
    from umh.runtime_engine.control_layer import ControlPolicy, ControlDecision
...
if TYPE_CHECKING:
    from umh.runtime_engine.calibration import CalibratedThresholds
...
class ControlPolicy:
    ...
    def evaluate(
        ...
        if goal_mode is not None:
            try:
                from umh.runtime_engine.goal_mode import MODE_CONTROL_SENSITIVITY
