...
class WorldPulse:
    ...
    def _scan_with_perplexity(self, queries: list[dict]) -> list[dict]:
        ...
        try:
            ...
            for query in queries:
                ...
                response = utility_llm_call(prompt, operation="world_pulse_intel")
    ...
    def run_market_intel_scan(self) -> dict:
        ...
        for sig in perplexity_signals:
            ...
            if ok:
                total_integrated += 1
            results_summary.append(f"{sig['category']}: intel via {sig['source']}")
        ...
        try:
            ...
            if skills_needing_review:
                print(f"[WorldPulse] Skills needing review: {skills_needing_review}")
        ...
        try:
            ...
            market_lines = [s for s in results_summary if "error" not in s and "skill:" not in s]
            report_lines = [
                "━━━━━━━━━━━━━━━━━━━━━━━━",
                "📊 **DAILY MARKET SCAN**",
                now,
    ...
    def run_pulse_scan(self) -> dict:
        ...
        gws_skipped = 0
        try:
            from umh.runtime_engine.gws_scanner import GWSDocumentScanner
            ...
            if docs:
                ...
                results_summary.append(f"google_docs: {gws_ingested} new/modified docs ingested")
