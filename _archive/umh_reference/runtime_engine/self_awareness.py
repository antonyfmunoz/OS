...
Usage:
    from umh.runtime_engine.self_awareness import SelfAwarenessEngine, SystemChange, ChangeType
...
class SelfAwarenessEngine:
    ...
    async def process_change(self, change: SystemChange) -> dict:
        ...
        for consequence in consequences:
            ...
            if 'notify' in consequence or 'discord' in consequence:
                try:
                    from umh.runtime_engine.output_validator import get_validator
    ...
    async def _execute(self, consequence: str, change: SystemChange) -> bool:
        ...
        # ── SYSTEM UPDATES ─────────────────────────────────────────────────────
            ...
            from umh.runtime_engine.stage_manager import StageManager
            ...
            from umh.runtime_engine.stage_manager import StageManager, detect_stage_transition
            ...
            try:
                from umh.runtime_engine.setup_wizard import generate_ea_soul_doc
                from umh.workstation.business import BusinessInstanceManager
