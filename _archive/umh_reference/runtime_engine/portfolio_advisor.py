...
Usage:
    ...
    from umh.runtime_engine.portfolio_advisor import PortfolioAdvisor, VentureHealth
...
trajectory of the next 90 days.]"""
        ...
        _extra: list[str] = []
        try:
            from umh.runtime_engine.task_yield_matrix import run_yield_audit
            import json as _json
            from umh.storage.adapters.neon import get_conn as _get_conn
