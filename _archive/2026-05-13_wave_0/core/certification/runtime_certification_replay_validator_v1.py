"""Runtime Certification Replay Validator v1.

Verifies: same substrate state → same certification result
→ same runtime attestation.
...
class RuntimeCertificationReplayValidator:
    """Validates replay determinism for certification runs."""

    def __init__(self) -> None:
        self._results: list[CertificationReplayState] = []
