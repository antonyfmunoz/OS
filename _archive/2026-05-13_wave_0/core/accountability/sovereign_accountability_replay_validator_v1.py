"""Sovereign Accountability Replay Validator v1.

Verifies: same historical state → same chronology
→ same accountability proof → same audit outputs.
...
class SovereignAccountabilityReplayValidator:
    def __init__(self) -> None:
        self._checks: list[AccountabilityReplayState] = []
    ...
    def validate_replay(self, check_name: str, input_data: str = "", output_data: str = "") -> dict[str, Any]:
        ...
        state = AccountabilityReplayState(
