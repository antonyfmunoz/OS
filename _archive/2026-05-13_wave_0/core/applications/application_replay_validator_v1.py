"""Application Replay Validator v1.

Verifies determinism: same application input + same substrate state
→ same projection routing + same capability bindings.

5 determinism checks for application projection operations.
...
REPLAY_CHECKS = [
    "projection_routing",
    "capability_binding",
    "domain_context_resolution",
    "continuity_restoration",
    "topology_resolution",
]


class ApplicationReplayValidator:
    """Validates determinism of application projection operations."""

    def __init__(self) -> None:
        self._results: list[ProjectionReplayState] = []
