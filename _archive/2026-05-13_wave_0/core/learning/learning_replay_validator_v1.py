"""Learning Replay Validator v1.

Verifies determinism: same outcomes + same corrections → same proposals.
5 determinism checks for learning operations.
...
class LearningReplayValidator:
    """Validates determinism of learning operations."""

    def __init__(self) -> None:
        self._results: list[LearningReplayState] = []
