...
|---|---|---|---|---|
| `data/agent_state` | 3 | 0 | 1,225 | 2026-05-05 |
| `data/archive` | 2 | 0 | 33,987,616,035 | 2026-07-01 |
| `data/audits` | 149 | 0 | 467,950,031 | 2026-07-07 |
| `data/backlog` | 1 | 0 | 2,211 | 2026-07-01 |
| `data/backups` | 2 | 0 | 9,462 | 2026-05-14 |
| `data/brand_identity.md` | 1 | 0 | 2,119 | 2026-05-05 |
| `data/c30-completion-report.md` | 1 | 0 | 6,072 | 2026-06-27 |
| `data/campaign2_operator_ascension_report.md` | 1 | 0 | 3,250 | 2026-06-17 |
| `data/campaigns` | 1 | 0 | 5,799 | 2026-06-30 |
...
| `data/drive_discovery_inventory.json` | 1 | 0 | 14,697 | 2026-05-04 |
| `data/drive_doc_cu_review_sample` | 2 | 0 | 2,469 | 2026-05-05 |
| `data/drive_doc_ingestion` | 31 | 0 | 212,380 | 2026-05-05 |
| `data/drive_doc_ingestion_tab_audit` | 1 | 0 | 69,326 | 2026-05-05 |
| `data/dry_validation` | 1 | 0 | 3,464 | 2026-05-06 |
| `data/founder_profile.md` | 1 | 0 | 2,885 | 2026-05-05 |
| `data/funnel_strategy.md` | 1 | 0 | 1,318 | 2026-05-05 |
| `data/gmail_audit.json` | 1 | 0 | 2,236 | 2026-05-05 |
| `data/graphify_overlay.json` | 1 | 0 | 462,570 | 2026-07-02 |
| `data/gws_context.md` | 1 | 0 | 3,049 | 2026-05-30 |
| `data/logs` | 0 | 1 | 0 | — |
...
| `data/proofs` | 10 | 0 | 64,507 | 2026-06-14 |
| `data/proposals` | 1 | 0 | 3,480 | 2026-05-12 |
| `data/qualification` | 3 | 0 | 2,964 | 2026-07-02 |
