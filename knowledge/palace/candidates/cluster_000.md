...
- `substrate/execution/workers/workstation/_dormant/governed_shell_adapter_v1.py`
- `substrate/execution/workers/workstation/_dormant/visible_gui_adapter_v1.py`
- `substrate/execution/workers/workstation/_dormant/workstation_state_registry_v1.py`
...
- `substrate/organism/mutation_router.py`
