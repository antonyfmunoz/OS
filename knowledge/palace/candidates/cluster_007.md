...
# Candidate Cluster — adapters/adapter_engine/adapter_manifest.py
...
**Size:** 28 files  
**Seed label:** `adapters/adapter_engine/adapter_manifest.py`
...
- `adapters/adapter_engine/production_manifests.py`
...
- `substrate/execution/workers/workstation/_dormant/workstation_relay_proof_v1.py`
