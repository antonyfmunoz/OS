...
_CORE_SKILLS: list[SkillV2] = [
    ...
    SkillV2(
        ...
        when_to_use=("When analyzing competitive landscape or preparing for sales conversations."),
    ...
    SkillV2(
        ...
        outputs=[
            "lead_file_created",
            "draft_response_queued",
            "followup_task_created",
            "notion_pipeline_updated",
        ],
        process=(
    ...
    SkillV2(
        ...
        outputs=[
            "antony_folder_routed",
            "discord_alert_sent",
            "research_brief",
            "holding_response_queued",
        ],
        process=(
            "Run person recognition. "
    ...
    SkillV2(
        ...
        outputs=[
            "qualifying_response_queued_or_spam_filed",
            "discord_flag",
            "lead_file_if_qualified",
        ],
        process=(
            "Run person recognition. "
            "Research sender. "
    ...
    SkillV2(
        ...
        outputs=[
            "antony_folder_routed",
            "discord_urgent_alert",
            "context_brief",
            "response_drafted_on_instruction",
        ],
        process=(
            "Run person recognition. "
    ...
    SkillV2(
        ...
        outputs=[
            ...
            "discord_flag_if_qualified",
            "holding_response_or_decline_queued",
        ],
        process=(
    ...
    SkillV2(
        ...
        outputs=[
            "routed_appropriately",
            "discord_flag_if_interesting",
            "holding_response_queued_if_relevant",
        ],
        process=(
