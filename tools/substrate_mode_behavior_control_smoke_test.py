...
from umh.substrate.mode_behavior import shape_reply, detect_internal_leakage
...
from umh.substrate.session_control import reset_session
...
import umh.substrate.mode_behavior as mb

mb_source = inspect.getsource(mb)
hot_path_imports = [
    "from eos.gateway",
    "from eos.cognitive_loop",
    "from eos.model_router",
    "from eos.agent_runtime",
    "from eos.primitives",
]
...
import umh.substrate.session_control as sc
...
from umh.runtime_engine.substrate import discord_text_transport as dtt
...
from umh.substrate.discord_text_transport import build_tts_reply_envelope
...
modules_to_check = [
    "umh.substrate.mode_behavior",
    "umh.substrate.session_control",
    "umh.substrate.discord_text_transport",
    "umh.substrate.discord_mode_routing",
    "umh.substrate.claude_session_bridge",
]
