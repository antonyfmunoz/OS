...
def cmd_report(args: argparse.Namespace) -> int:
    from umh.substrate.stt_producer import (
        recent_stt_captures,
...
def cmd_readiness(args: argparse.Namespace) -> int:
    ...
    """
    from umh.substrate.stt_producer import stt_workstation_readiness
...
def cmd_devices(args: argparse.Namespace) -> int:
    ...
    from umh.substrate.stt_producer import _enumerate_input_devices  # noqa: WPS450
...
def cmd_capture(args: argparse.Namespace) -> int:
    from umh.substrate.stt_producer import get_local_stt_runtime
...
def cmd_recent(args: argparse.Namespace) -> int:
    from umh.substrate.stt_producer import recent_stt_captures
