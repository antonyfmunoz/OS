...
def main() -> int:
    from umh.runtime_engine import model_router as mr
    from umh.runtime_engine.substrate import claude_responder as cr
    from umh.runtime_engine.substrate import claude_session_bridge as csb
