...
Proves the broader router (eos.model_router.call_with_fallback) now:
...
from umh.runtime_engine import model_router as mr  # noqa: E402
from umh.runtime_engine.model_router import (  # noqa: E402
    ModelProvider,
    PROVIDER_PRIORITY,
...
class _FakeClaudeResponder:
    """Stand-in for eos.substrate.claude_responder.respond_via_claude_session."""
