...
def test_classification() -> None:
    ...
    from umh.runtime_engine.substrate import discord_mode_routing as dmr
...
def test_end_to_end_router_override() -> None:
    ...
    import umh.substrate.claude_responder as cr
...
def test_ingest_adds_mode_metadata() -> None:
    ...
    from umh.runtime_engine.substrate import transcript_inject as ti
    ...
    import umh.substrate.discord_voice_transport as dvt
...
def test_shared_router_tripwire() -> None:
    ...
    check(
        ...
        "from eos.model_router" not in src
        and "import umh.runtime_engine.model_router" not in src,
    )
