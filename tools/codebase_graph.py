...
try:
    from tools.parsers_lib import REGISTRY as PARSER_REGISTRY
    from tools.parsers_lib.base import ParsedFile
    ...
    for rel, file_node in graph.files.items():
        for imp in file_node.imports:
            ...
            if mod in module_to_path:
                ...
                # Try parent module (from umh.storage.adapters.neon import get_conn)
...
def _slug(name: str) -> str:
    ...
    # eos/gateway.py::GatewayRouter.classify → eos_ai-gateway-GatewayRouter-classify
