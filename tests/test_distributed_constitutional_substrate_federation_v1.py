...
class TestRegistryIntegration(unittest.TestCase):
    ...
    def test_action_types_count(self) -> None:
        ...
        self.assertEqual(len(ALLOWED_ACTION_TYPES), 24)
    ...
    def test_router_map_count(self) -> None:
        ...
        self.assertEqual(len(ACTION_CAPABILITY_MAP), 24)
    ...
    def test_config_has_federation(self) -> None:
        ...
        self.assertEqual(len(data["allowed_action_types"]), 24)
    ...
    def test_handler_dispatch_has_federation(self) -> None:
        ...
        self.assertEqual(len(SUBSTRATE_COMMANDS), 24)
