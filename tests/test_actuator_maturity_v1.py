...
class TestCanonicalRegistryInclusion:
    ...
    def test_canonical_registry_now_has_12_commands(self) -> None:
        from core.registry.canonical_command_registry_v1 import (
            CanonicalCommandRegistryV1,
        )
...
class TestRegressionIntegrity:
    def test_all_new_files_compile(self) -> None:
        ...
        files = [
            "/opt/OS/core/actuation/actuator_maturity_v1.py",
            "/opt/OS/core/actuation/actuator_backend_registry_v1.py",
            "/opt/OS/core/actuation/observed_desktop_state_v1.py",
            "/opt/OS/core/actuation/windows_foreground_actuator_v1.py",
        ]
        for f in files:
    ...
    def test_existing_files_still_compile(self) -> None:
        ...
        files = [
            ...
            "/opt/OS/core/control_plane_router/router_contracts.py",
            "/opt/OS/core/control_plane_router/control_plane_router_v1.py",
