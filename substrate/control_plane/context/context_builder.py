...
class ContextBuilder:
    ...
    def _build_inner(
        ...
        # Layer 0: AI Identity
        try:
            from substrate.control_plane.identity.ai_identity import AIIdentityEngine
        ...
        try:
            from substrate.control_plane.signals.signal_hierarchy import SignalHierarchyEngine
        ...
        # Layer 1f: Primitives
        try:
            from substrate.state.business.primitives import PrimitiveRegistry
        ...
        # Intent detection
        try:
            from substrate.control_plane.runtime.cognitive_loop import (
