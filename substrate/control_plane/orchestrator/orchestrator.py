"""
Orchestrator — strategic intelligence layer.
...
class CEOAgent:
    ...
    def __init__(self, ctx: SubstrateContext, org_id: str) -> None:
    ...
    def delegate_objective(self, objective: str, venture_id: str) -> dict:
        ...
        try:
            from substrate.control_plane.runtime.gateway import get_gateway as _get_gw
...
def run_full_morning_cycle(ctx: SubstrateContext, return_content: bool = False):
    """
    ...
    Replaces the old Orchestrator.run_morning_cycle().
    ...
    pa = None
    try:
        from substrate.control_plane.strategy.portfolio_advisor import PortfolioAdvisor
    ...
    try:
        from substrate.control_plane.agents.ceo_agent import CEOAgent as _CEOEvolutionAgent
    ...
    binding = ""
    try:
        from substrate.control_plane.strategy.strategy_engine import StrategyEngine
...
def run_ceo_morning_delegation(
    ...
    from substrate.control_plane.agents.ceo_agent import CEOAgent as _EvoCEO
    from substrate.control_plane.coordination.coordination_engine import CoordinationEngine as _CE
    from substrate.control_plane.strategy.portfolio_advisor import PortfolioAdvisor as _PA
    ...
    for venture_config in venture_list[:3]:
        ...
        try:
            ...
            from substrate.state.context.context import SubstrateContext as _EC
...
def check_proactive_triggers(ctx: SubstrateContext) -> list[str]:
    """
...
def check_outcome_milestone(ctx: SubstrateContext, new_outcome_count: int) -> None:
    """
...
async def generate_morning_brief(ctx: SubstrateContext) -> str:
    """
    DEPRECATED: Use run_full_morning_cycle() instead.
    ...
    try:
        from substrate.control_plane.runtime.gateway import get_gateway as _get_gw_brief
...
def write_to_notion_dashboard(ctx: SubstrateContext, morning_data: dict) -> None:
    """
...
def refresh_ambient_state(ctx: SubstrateContext) -> None:
    """
...
def start_ambient_refresh_loop(ctx: SubstrateContext) -> None:
    """
    ...
    def _refresh_loop() -> None:
        while True:
            ...
            try:
                from substrate.control_plane.proactive.proactive_engine import ProactiveIntelligenceEngine
...
EntrepreneurOSOrchestrator = Orchestrator
