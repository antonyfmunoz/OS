...
Usage:
    ...
    from substrate.control_plane.strategy.portfolio_advisor import PortfolioAdvisor, VentureHealth
...
trajectory of the next 90 days.]"""
        ...
        _extra: list[str] = []
        try:
            from substrate.control_plane.strategy.task_yield_matrix import run_yield_audit
