...
CANONICAL_COMMANDS: tuple[CommandEntry, ...] = (
    ...
    CommandEntry(
        ...
        execution_mode=CommandExecutionMode.GUI,
    ),
    CommandEntry(
    ...
    CommandEntry(
        command_name="!capability-report",
        canonical_action="capability_report",
        routing_mode=RoutingMode.SPINE,
        governance_policy="FOUNDER_APPROVAL",
        execution_mode=CommandExecutionMode.SHELL,
        foreground_required=False,
    ...
    CommandEntry(
        command_name="!continuity-report",
        canonical_action="continuity_report",
        routing_mode=RoutingMode.SPINE,
        governance_policy="FOUNDER_APPROVAL",
        execution_mode=CommandExecutionMode.SHELL,
        foreground_required=False,
    ...
    CommandEntry(
        ...
        canonical_action="constitution_report",
        routing_mode=RoutingMode.SPINE,
        governance_policy="FOUNDER_APPROVAL",
        execution_mode=CommandExecutionMode.SHELL,
        foreground_required=False,
    ...
    CommandEntry(
        command_name="!economics-report",
        canonical_action="economics_report",
        routing_mode=RoutingMode.SPINE,
        governance_policy="FOUNDER_APPROVAL",
        execution_mode=CommandExecutionMode.SHELL,
        foreground_required=False,
    ...
    CommandEntry(
        command_name="!identity-report",
        canonical_action="identity_report",
        routing_mode=RoutingMode.SPINE,
        governance_policy="FOUNDER_APPROVAL",
        execution_mode=CommandExecutionMode.SHELL,
        foreground_required=False,
        require_screenshot_proof=False,
        capability_type="IDENTITY_CONTINUITY",
    ),
    CommandEntry(
        command_name="!telos-report",
        canonical_action="telos_report",
        routing_mode=RoutingMode.SPINE,
        governance_policy="FOUNDER_APPROVAL",
        execution_mode=CommandExecutionMode.SHELL,
        foreground_required=False,
