...
from substrate.execution.transport.actions import SafeAction
from substrate.execution.transport.nodes import NodeRegistry, NodeStatus
from substrate.execution.transport.result_query import node_health_summary
from substrate.execution.transport.ritual_inference import InferredHint, infer_open_scene_hint
from substrate.execution.transport.rituals import Ritual, RitualKind, RitualRegistry
...
from substrate.execution.transport.station_helpers import (
    propose_open_scene,
    propose_play_sound,
    propose_speak_text,
)
from substrate.execution.transport.station_readiness import (
    DEGRADED,
    READY,
    UNAVAILABLE,
    StationReadiness,
