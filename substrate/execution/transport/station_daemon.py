...
Operator entrypoint:
    python3 -m execution.transport.station_daemon --node-id antony-workstation
...
from substrate.execution.transport.actions import (
    ActionKind,
    ActionResult,
    ActionStatus,
    SafeAction,
)
from substrate.execution.transport.app_allowlist import resolve_app
from substrate.execution.transport.nodes import Node, NodeRegistry, NodeStatus, NodeType
from substrate.execution.transport.scenes import Scene, SceneStep, get_scene
from substrate.execution.transport.station import StationEvent
from substrate.execution.transport.station_bus import StationBus, get_station_bus
...
class StationDaemon:
    ...
    def _start_http_transport(self) -> None:
        ...
        try:
            import asyncio
            from substrate.execution.transport.node_transport import NodeTransportServer
