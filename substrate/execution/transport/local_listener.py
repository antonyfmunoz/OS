...
from substrate.execution.transport.ritual_body import RitualPolicy
from substrate.execution.transport.ritual_runner import start_open_day
from substrate.execution.transport.rituals import RitualRegistry
from substrate.execution.transport.station_readiness import UNAVAILABLE, station_readiness
...
class LocalListener:
    ...
    def _activate(self, trigger: LocalTrigger) -> None:
        ...
        try:
            from substrate.execution.transport.rituals import (
                RitualKind,
