...
def _execute_via_pipeline(
    ...
    *,
    ...
    """
    from substrate.execution.transport.task_pipeline import (
        PipelineStatus,
        PipelineStore,
    )
    from substrate.execution.transport.task_decomposition import decompose_task
    from substrate.execution.transport.pipeline_execution import execute_pipeline
...
def _sync_pipeline_to_task(task: Task, pipeline: "TaskPipeline") -> None:
    ...
    """
    from substrate.execution.transport.task_pipeline import PipelineStatus
    ...
    if not task.required_capabilities:
        try:
            from substrate.execution.transport.capability_routing import infer_task_capabilities
...
def _execute_legacy(
    ...
    *,
    ...
    # ── Route the task ──────────────────────────────────────────────────────
    from substrate.execution.transport.capability_routing import route_task
    ...
    try:
        from substrate.execution.transport.claude_session_bridge import ask_session
...
def run_overnight_execution(
    ...
    *,
    ...
    """
    from substrate.execution.transport.task_queue import get_tasks_sorted_for_execution
