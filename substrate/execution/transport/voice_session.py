...
from substrate.execution.transport.roles import AgentRole, RoleRegistry
...
def _apply_operator_state(session: "VoiceSession", lifecycle: str) -> None:
    ...
    """
    try:
        from substrate.execution.transport.operator_transitions import apply_voice_session
...
class VoiceSessionRuntime:
    ...
    def end_session(
        ...
        *,
        ...
        try:
            from substrate.execution.transport.audio_loop import mark_inactive
    ...
    def submit_utterance(
        ...
        *,
        ...
        try:
            from substrate.execution.transport.audio_loop import (
                mark_listening,
                record_transcript,
            )
        ...
        try:
            from substrate.execution.transport.audio_loop import mark_responding
        ...
        try:
            from substrate.execution.transport.audio_loop import mark_cooling_down
