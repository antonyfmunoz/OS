...
Usage (contract consumer side — substrate, not daemon):
    from substrate.execution.transport import StationContract, StationHeartbeat
...
from substrate.execution.transport.actions import SafeAction, ActionResult, ActionKind, ActionStatus
...
class StationContract:
    ...
    def propose(self, action: SafeAction) -> SafeAction:
        ...
        try:
            from substrate.execution.transport.station_bus import get_station_bus
