...
def _execute_step(
    ...
    *,
    ...
    # ── Route the step ──────────────────────────────────────────────────────
    try:
        from substrate.execution.transport.capability_routing import choose_execution_target
        from substrate.execution.transport.task_system import Task, TaskExecutionPolicy, TaskStatus
    ...
    try:
        from substrate.execution.transport.task_execution import _resolve_tmux_target
    ...
    if result.get("ok"):
        ...
        from substrate.execution.transport.task_execution import detect_human_block
