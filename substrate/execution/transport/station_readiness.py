...
from substrate.execution.transport.result_store import ResultStore, get_result_store
...
def station_readiness(
    ...
    *,
    ...
    try:
        from substrate.execution.transport.scene_capabilities import node_supports
