...
from substrate.execution.transport.capabilities import Capability
from substrate.execution.transport.scenes import SCENE_REGISTRY, Scene

if TYPE_CHECKING:  # avoid runtime cycle
    from substrate.execution.transport.nodes import Node
