...
def _dispatch_browser_open_url(req: LocalControlRequest) -> LocalControlRequest:
    ...
    from substrate.execution.transport.browser_agent import BrowserActionType, execute_browser_action
...
def _dispatch_browser_press_keys(req: LocalControlRequest) -> LocalControlRequest:
    ...
    from substrate.execution.transport.browser_agent import get_browser_agent
