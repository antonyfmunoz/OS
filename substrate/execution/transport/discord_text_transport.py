...
def _handle_session_command(
    ...
    *,
    ...
    try:
        from substrate.execution.transport.session_control import clear_session, reset_session
...
def maybe_mirror_discord_text_message(
    ...
    *,
    ...
    try:
        from substrate.execution.transport.discord_mode_routing import resolve_discord_mode
        from substrate.execution.transport.mode_behavior import shape_reply
    ...
    try:
        from substrate.execution.transport.discord_mode_routing import resolve_discord_mode as _rdm
        from substrate.execution.transport.discord_mode_routing import resolve_mode_session as _rms
...
def _hybrid_execution_status() -> dict[str, Any]:
    ...
    try:
        from substrate.execution.transport.target_policy import (
            POLICY_VERSION,
