...
from substrate.execution.bridge.result_store import ResultStore, get_result_store
...
def station_readiness(
    ...
    *,
    ...
    try:
        from substrate.execution.bridge.scene_capabilities import node_supports
