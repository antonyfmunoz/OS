...
from substrate.execution.bridge.ritual_body import RitualPolicy
from substrate.execution.bridge.ritual_runner import start_open_day
from substrate.execution.bridge.rituals import RitualRegistry
from substrate.execution.bridge.station_readiness import UNAVAILABLE, station_readiness
...
class LocalListener:
    ...
    def start_voice_session(
        ...
        *,
        ...
        """
        try:
            from substrate.execution.bridge.voice_session import VoiceSessionRuntime
        except Exception as e:  # noqa: BLE001
    ...
    def _activate(self, trigger: LocalTrigger) -> None:
        ...
        try:
            from substrate.execution.bridge.rituals import (
                RitualKind,
