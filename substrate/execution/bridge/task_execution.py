...
def _execute_via_pipeline(
    ...
    *,
    ...
    from substrate.execution.bridge.task_decomposition import decompose_task
    from substrate.execution.bridge.pipeline_execution import execute_pipeline
...
def _sync_pipeline_to_task(task: Task, pipeline: "TaskPipeline") -> None:
    ...
    """
    from substrate.execution.bridge.task_pipeline import PipelineStatus
...
def _execute_legacy(
    ...
    *,
    ...
    # ── Route the task ──────────────────────────────────────────────────────
    from substrate.execution.bridge.capability_routing import route_task
...
def run_overnight_execution(
    ...
    *,
    ...
    """
    from substrate.execution.bridge.task_queue import get_tasks_sorted_for_execution
