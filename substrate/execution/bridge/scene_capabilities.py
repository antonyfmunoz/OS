...
from substrate.execution.bridge.capabilities import Capability
from substrate.execution.bridge.scenes import SCENE_REGISTRY, Scene

if TYPE_CHECKING:  # avoid runtime cycle
    from substrate.execution.bridge.nodes import Node
