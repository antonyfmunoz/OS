...
from substrate.execution.bridge.actions import SafeAction, ActionResult, ActionKind, ActionStatus
...
class StationContract:
    ...
    def propose(self, action: SafeAction) -> SafeAction:
        ...
        try:
            from substrate.execution.bridge.station_bus import get_station_bus
