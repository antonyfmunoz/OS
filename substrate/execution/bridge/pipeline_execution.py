...
from substrate.execution.bridge.task_pipeline import (
    PipelineStatus,
    PipelineStore,
    PipelineStep,
    StepStatus,
...
def _execute_step(
    ...
    *,
    ...
    # ── Route the step ──────────────────────────────────────────────────────
    try:
        from substrate.execution.bridge.capability_routing import choose_execution_target
        from substrate.execution.bridge.task_system import Task, TaskExecutionPolicy, TaskStatus
    ...
    try:
        from substrate.execution.bridge.task_execution import _resolve_tmux_target

        tmux_target, session_name = _resolve_tmux_target(step.chosen_target)

        from substrate.execution.bridge.claude_session_bridge import ask_session
    ...
    if result.get("ok"):
        ...
        from substrate.execution.bridge.task_execution import detect_human_block
