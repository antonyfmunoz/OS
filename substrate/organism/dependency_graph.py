...
_KNOWN_DEPENDENCIES: list[tuple[str, str, DependencyType, DependencyStrength, str]] = [
    ...
    ("leverage_assimilation", "leverage_engine", DependencyType.DATA, DependencyStrength.HARD,
     "LeverageAssimilator feeds into leverage engine"),
    ("leverage_assimilation", "event_spine", DependencyType.EVENT, DependencyStrength.SOFT,
     "LeverageAssimilator emits assimilation events"),
    ("advisor_hierarchy", "advisor", DependencyType.RUNTIME, DependencyStrength.HARD,
     "AdvisorHierarchy extends advisor with multi-level structure"),
    ("advisor_hierarchy", "event_spine", DependencyType.EVENT, DependencyStrength.SOFT,
