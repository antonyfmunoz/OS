"""Jarvis acceptance scenarios — predefined end-to-end test scenarios.
...
class AcceptanceScenario:
    """A single predefined acceptance scenario for Jarvis end-to-end validation."""

    scenario_id: str  # "jas-<letter>"
    name: str
    input_text: str
    input_mode: str  # "text"
...
SCENARIO_A = AcceptanceScenario(
    ...
    input_text=(
        ...
        "Use what UMH knows, inspect the current state, and run a sandboxed "
    ...
    success_criteria=[
        "deterministic intent classification to create_work",
...
SCENARIO_B = AcceptanceScenario(
    ...
    success_criteria=[
        ...
        "deterministic-only degraded mode stated",
        "standard Phase 13.4 blocker identified: no capable LLM provider",
