...
CANONICAL_TYPES: dict[str, list[str]] = {
    ...
    # ── substrate/organism/ (Phase 13.3 — Context Assimilation) ─────────
    "SourceType": ["substrate.organism.source_registry"],
    "SyncPolicy": ["substrate.organism.source_registry"],
    "Canonicality": ["substrate.organism.source_registry"],
    "SourceStatus": ["substrate.organism.source_registry"],
    "JobType": ["substrate.organism.ingestion_job"],
    "JobStatus": ["substrate.organism.ingestion_job"],
    "ContradictionType": ["substrate.organism.context_diagnostic"],
    "DiagnosticStatus": ["substrate.organism.context_diagnostic"],
    "ProposalType": ["substrate.organism.canonical_update"],
    "ProposalStatus": ["substrate.organism.canonical_update"],
    "SessionStatus": ["substrate.organism.reconciliation_session"],
    "ReconciliationMode": ["substrate.organism.reconciliation_session"],
    "CanonicalDirection": ["substrate.organism.sync_policy"],
    "ReadPolicy": ["substrate.organism.sync_policy"],
    "WritePolicy": ["substrate.organism.sync_policy"],
    "ConflictPolicy": ["substrate.organism.sync_policy"],
    "ExternalSyncStatus": ["substrate.organism.sync_policy"],
    "DeviceType": ["substrate.organism.environment_discovery"],
    "DiscoveryStatus": ["substrate.organism.environment_discovery"],
    "PermissionState": ["substrate.organism.environment_discovery"],
    "AppType": ["substrate.organism.environment_discovery"],
    "UsageStatus": ["substrate.organism.environment_discovery"],
    "ScopeStatus": ["substrate.organism.environment_discovery"],
    "ApprovalOption": ["substrate.organism.permission_dialogue"],
    "RequestStatus": ["substrate.organism.permission_dialogue"],
    "Sensitivity": ["substrate.organism.permission_dialogue"],
    "SignalType": ["substrate.organism.cross_source_reconciler"],
    "SignalStatus": ["substrate.organism.cross_source_reconciler"],
}
