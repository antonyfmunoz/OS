...
async def _handle_resilience_report(message: Any, spine: Any) -> None:
    from substrate.execution.workers.workstation._dormant.constitutional_antifragility_resilience_engine_v1 import (
    ...
    from substrate.execution.workers.workstation._dormant.constitutional_identity_continuity_engine_v1 import (
        build_full_identity_proof,
    )
    from substrate.execution.workers.workstation._dormant.constitutional_telos_alignment_engine_v1 import (
