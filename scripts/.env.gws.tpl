...
GWS_OAUTH_CLIENT_ID=op://UMH-Production/Google-Workspace-OAuth/client_id
GWS_OAUTH_CLIENT_SECRET=op://UMH-Production/Google-Workspace-OAuth/client_secret
GWS_OAUTH_REFRESH_TOKEN=op://UMH-Production/Google-Workspace-OAuth/refresh_token
