...
def test_workload_lightweight_question() -> None:
    ...
    from execution.transport.workload_policy import classify_workload
...
def test_workload_weight_order() -> None:
    ...
    from execution.transport.workload_policy import workload_weight_order
...
def test_resource_snapshot_keys() -> None:
    ...
    from execution.transport.resource_guard import current_resource_snapshot
...
def test_guard_disabled_default() -> None:
    ...
    from execution.transport.resource_guard import evaluate_resource_guard
...
def test_low_message_count_low_pressure() -> None:
    ...
    from execution.transport.context_lifecycle import detect_context_pressure
...
def test_checkpoint_builds_correctly() -> None:
    ...
    from execution.transport.context_lifecycle import build_context_checkpoint
...
def test_restore_from_checkpoint() -> None:
    ...
    from execution.transport.context_lifecycle import (
