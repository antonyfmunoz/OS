...
from execution.transport.session_watcher import get_watcher, start_watcher
...
from execution.transport.session_watcher import ask_session_watched
...
from execution.transport.claude_session_bridge import _scrub_cli_chrome
