...
from substrate.execution.bridge.session_watcher import get_watcher, start_watcher
...
from substrate.execution.bridge.session_watcher import ask_session_watched
...
from substrate.execution.bridge.claude_session_bridge import _scrub_cli_chrome
