...
LEGACY_VIOLATIONS: set[str] = {
    ...
    # ── substrate/ → adapters/ (C31 Phase 2C: now detected, grandfathered for migration) ──
    # 56 files import from adapters/. Each needs a contract/port in substrate/ or lazy loading.
    # Track migration progress: count should decrease toward 0.
