...
def test_target_policy_defaults() -> None:
    ...
    from substrate.execution.bridge.target_policy import resolve_execution_target
...
def test_resolve_mode_session_builder_local() -> None:
    ...
    from substrate.execution.bridge.discord_mode_routing import resolve_mode_session
...
def test_pseudo_live_status_reports_policy() -> None:
    ...
    try:
        from substrate.execution.bridge.discord_text_transport import pseudo_live_status
