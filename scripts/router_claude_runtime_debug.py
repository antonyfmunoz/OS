...
def main() -> int:
    from substrate.execution.runtime import model_router as mr
    from substrate.execution.transport import claude_responder as cr
    from substrate.execution.transport import claude_session_bridge as csb
