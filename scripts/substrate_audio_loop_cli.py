...
def cmd_report(args: argparse.Namespace) -> int:
    try:
        from substrate.execution.bridge.result_query import audio_loop_snapshot
...
def cmd_report_node(args: argparse.Namespace) -> int:
    try:
        from substrate.execution.bridge.result_query import (
            audio_loop_snapshot,
...
def cmd_inject_transcript(args: argparse.Namespace) -> int:
    try:
        from substrate.execution.bridge.transcript_inject import inject_transcript
...
def cmd_prime(args: argparse.Namespace) -> int:
    try:
        from substrate.execution.bridge.audio_loop import mark_primed
