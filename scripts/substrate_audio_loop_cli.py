...
def cmd_report(args: argparse.Namespace) -> int:
    try:
        from execution.transport.result_query import audio_loop_snapshot
...
def cmd_report_node(args: argparse.Namespace) -> int:
    try:
        from execution.transport.result_query import (
            audio_loop_snapshot,
...
def cmd_inject_transcript(args: argparse.Namespace) -> int:
    try:
        from execution.transport.transcript_inject import inject_transcript
