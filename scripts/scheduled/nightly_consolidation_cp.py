...
from substrate.control_plane.runtime.orchestrator.steps import ScriptWorkflowSpec, run_script_workflow

SCRIPT_PATH = f"{_ROOT}/scripts/scheduled/nightly_consolidation.sh"
