...
def test_classification() -> None:
    ...
    from substrate.execution.bridge import discord_mode_routing as dmr
...
def test_end_to_end_router_override() -> None:
    ...
    import execution.bridge.claude_responder as cr
...
def test_ingest_adds_mode_metadata() -> None:
    ...
    from substrate.execution.bridge import transcript_inject as ti
    ...
    import execution.bridge.discord_voice_transport as dvt
...
def test_shared_router_tripwire() -> None:
    ...
    check(
        ...
        "from substrate.execution.runtime.model_router" not in src
