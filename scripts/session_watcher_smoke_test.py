...
try:
    from substrate.execution.bridge.session_discord_bridge import (
...
from substrate.execution.bridge.session_watcher import _STABLE_CYCLES_FOR_COMPLETE
...
from substrate.execution.bridge.session_watcher import _TOOL_CALL_PATTERNS
...
from substrate.execution.bridge.session_watcher import _IDLE_TIMEOUT_S, _WORKING_TIMEOUT_S
