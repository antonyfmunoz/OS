...
print("\n1. Imports")
try:
    from substrate.execution.transport.session_watcher import (
        SessionState,
        SessionWatcher,
        WatcherEvent,
        get_watcher,
...
from substrate.execution.transport.session_watcher import _STABLE_CYCLES_FOR_COMPLETE
...
from substrate.execution.transport.session_watcher import _TOOL_CALL_PATTERNS
...
from substrate.execution.transport.session_watcher import _IDLE_TIMEOUT_S, _WORKING_TIMEOUT_S
