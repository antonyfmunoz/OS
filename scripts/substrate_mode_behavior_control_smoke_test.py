...
from substrate.execution.bridge.mode_behavior import shape_reply, detect_internal_leakage
...
from substrate.execution.bridge.session_control import clear_session
...
from substrate.execution.bridge.session_control import reset_session
...
import substrate.execution.bridge.mode_behavior as mb

mb_source = inspect.getsource(mb)
hot_path_imports = [
    "from substrate.control_plane.runtime.gateway",
    "from substrate.control_plane.runtime.cognitive_loop",
    "from substrate.execution.runtime.model_router",
    "from substrate.execution.runtime.agent_runtime",
...
import substrate.execution.bridge.session_control as sc
...
from substrate.execution.bridge import discord_text_transport as dtt
...
from substrate.execution.bridge.discord_text_transport import build_tts_reply_envelope
...
modules_to_check = [
    "substrate.execution.bridge.mode_behavior",
    "substrate.execution.bridge.session_control",
    "substrate.execution.bridge.discord_text_transport",
    "substrate.execution.bridge.discord_mode_routing",
    "substrate.execution.bridge.claude_session_bridge",
]
