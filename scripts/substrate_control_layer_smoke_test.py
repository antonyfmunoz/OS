...
from eos_ai.substrate import control_bridge as cb  # noqa: E402
from eos_ai.substrate import control_commands as cc  # noqa: E402
from eos_ai.substrate import local_executor as lx  # noqa: E402
...
def main() -> int:
    ...
    try:
        from eos_ai.substrate import operator_interface as oi  # noqa: F401
