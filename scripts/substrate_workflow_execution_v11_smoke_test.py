...
def main() -> None:
    ...
    def test_version_is_v11():
        from substrate.execution.bridge.workflow_execution import LAYER_VERSION
    ...
    def test_analysis_not_deferred():
        from substrate.execution.bridge.workflow_execution import execute_workflow_if_allowed
    ...
    def test_analysis_handler_directly():
        ...
        from substrate.execution.bridge.workflow_execution import _handle_analysis
    ...
    def test_content_ops_handler_directly():
        from substrate.execution.bridge.workflow_execution import _handle_content_ops
    ...
    def test_hot_path_modules_clean():
        ...
        mod_name = "substrate.execution.bridge.workflow_execution"
    ...
    def test_handler_registry_complete():
        from substrate.execution.bridge.workflow_execution import _HANDLER_REGISTRY
    ...
    def test_delegation_layer_independent():
        from substrate.execution.bridge.workflow_delegation import (
