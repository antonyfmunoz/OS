...
def main() -> None:
    ...
    def test_version_is_v11():
        from substrate.execution.transport.workflow_execution import LAYER_VERSION
    ...
    def test_analysis_handler_directly():
        ...
        from substrate.execution.transport.workflow_execution import _handle_analysis
    ...
    def test_content_ops_handler_directly():
        from substrate.execution.transport.workflow_execution import _handle_content_ops
    ...
    def test_handler_registry_complete():
        from substrate.execution.transport.workflow_execution import _HANDLER_REGISTRY
