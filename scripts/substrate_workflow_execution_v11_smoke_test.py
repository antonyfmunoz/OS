...
def main() -> None:
    ...
    def test_version_is_v11():
        from eos_ai.substrate.workflow_execution import LAYER_VERSION
    ...
    def test_analysis_not_deferred():
        from eos_ai.substrate.workflow_execution import execute_workflow_if_allowed
    ...
    def test_analysis_handler_directly():
        ...
        from eos_ai.substrate.workflow_execution import _handle_analysis
    ...
    def test_content_ops_handler_directly():
        from eos_ai.substrate.workflow_execution import _handle_content_ops
    ...
    def test_prefix_functions():
        from eos_ai.substrate.workflow_execution import (
            _analysis_prefix,
            _content_ops_prefix,
        )
    ...
    def test_hot_path_modules_clean():
        ...
        mod_name = "eos_ai.substrate.workflow_execution"
    ...
    def test_handler_registry_complete():
        from eos_ai.substrate.workflow_execution import _HANDLER_REGISTRY
