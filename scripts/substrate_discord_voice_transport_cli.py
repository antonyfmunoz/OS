...
def cmd_report(args: argparse.Namespace) -> int:
    from substrate.execution.transport.discord_voice_transport import get_transport_history
...
def cmd_playback_status(args: argparse.Namespace) -> int:
    from substrate.execution.transport.discord_voice_playback import (
